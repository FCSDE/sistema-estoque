...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="'+classes.sFilterInput+'" style="height:30px; min-width:300px; padding:7px; border-radius:6px; border:1px solid #06C;"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Exibindo 0 até 0 of 0 entradas",
