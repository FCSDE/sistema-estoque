...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default Exibindo _START_ até _END_ de _TOTAL_ entries
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtrado para _MAX_ total entradas)",
		 ...
		 *
		 * * `simple` - 'Anterior' and 'Proximo' buttons only
		 * * 'simple_numbers` - 'Anterior' and 'Proximo' buttons, plus page numbers
		 * * `full` - 'First', 'Anterior', 'Proximo' and 'Last' buttons
		 * * `full_numbers` - 'First', 'Anterior', 'Proximo' and 'Last' buttons, plus
		 *   page numbers
		 *  
